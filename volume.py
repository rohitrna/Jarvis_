...
def increaseVolumeSet():
    vol1 = volume.GetMasterVolumeLevel()
    vol1 = (vol1 + 5.31)
    volume.SetMasterVolumeLevel( vol1, None) #Change the first argument for controlling the volume remember it should be -ve not less than -65

def decreaseVolumeSet():
    vol1 = volume.GetMasterVolumeLevel()
    vol1 = (vol1 - 1)
    volume.SetMasterVolumeLevel( vol1, None) #Change the first argument for controlling the volume remember it should be -ve not less than -65
...
def VolumeSetMute():
    ...
    volume.SetMasterVolumeLevel( -74, None) #Change the first argument for controlling the volume remember it should be -ve not less than -65
...
def VolumeSetMax():
    ...
    volume.SetMasterVolumeLevel( -0, None) #Change the first argument for controlling the volume remember it should be -ve not less than -65
